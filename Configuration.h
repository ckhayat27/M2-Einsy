...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Ultimaker
  #define DEFAULT_Kp 25.89   //22.2
  #define DEFAULT_Ki 1.94    //1.08
  #define DEFAULT_Kd 86.53   //114
...
//define driver types to correspond with spi microstepping of einsy board
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 88.89, 88.89, 1058.4, 471.57 }  //calculated for specific motors on makergear m2
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 200, 200, 5, 25 }   //z-axis speed needs to be increased
 ...
 */
#define DEFAULT_ACCELERATION          2000    // X, Y, Z and E acceleration for printing moves (2000)
...
#define INVERT_Z_DIR true  //initally false
